...
export const espacosFoto: EspacoFoto[] = [
  { numero: 1, local: 'Home — abertura', proporcao: '3/4', arquivo: '/fotos/01.webp',
    descricao: 'Caio em meditação no jardim — a imagem de abertura do site.',
    alt: 'Caio Gracco em meditação, sentado na grama de um jardim' },
  ...
  { numero: 4, local: 'Sobre — retrato principal', proporcao: '3/4', arquivo: '/fotos/04.webp',
    descricao: 'Retrato em meditação, de perfil — a foto que constrói confiança na página Sobre.',
    alt: 'Caio Gracco em meditação, de perfil, sob a luz da manhã' },
  ...
  { numero: 10, local: 'Terapia — Reiki', proporcao: '4/3', arquivo: '/fotos/10.webp',
    descricao: 'Postura de meditação, mãos abertas — a atitude de receber.',
    alt: 'Postura de meditação, mãos abertas sobre os joelhos' },
