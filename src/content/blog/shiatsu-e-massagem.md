---json
{
  "titulo": "Shiatsu é massagem? A diferença que muda o resultado",
  "tituloCurto": "Shiatsu é massagem?",
  "slug": "shiatsu-e-massagem",
  "resumo": "Shiatsu e massagem relaxante não são a mesma coisa: muda o mapa, muda o tipo de pressão e muda o que se pode esperar. Um texto brasileiro sobre o que acontece numa sessão.",
  "descricao": "Shiatsu é massagem? A diferença real para a massagem relaxante, se precisa tirar a roupa, se dói, a relação com a acupuntura e quando não fazer.",
  "categoria": "praticas",
  "publicadoEm": "2026-08-22",
  "terapias": ["shiatsu", "acupuntura-sistemica"],
  "palavrasChave": [
    "shiatsu é massagem",
    "diferença entre shiatsu e massagem",
    "shiatsu o que é",
    "shiatsu precisa tirar a roupa",
    "shiatsu dói"
  ],
  "peso": 56,
  "faq": [
    {
      "pergunta": "Shiatsu é massagem?",
      "resposta": "Não no sentido usual da palavra. A massagem relaxante trabalha o tecido muscular com deslizamento e amassamento, em geral com óleo e sobre a pele. O Shiatsu aplica pressão sustentada e perpendicular em pontos de um mapa de meridianos herdado da medicina tradicional chinesa, com a pessoa vestida e sem óleo. O gesto é diferente e o objetivo declarado também."
    },
    {
      "pergunta": "Preciso tirar a roupa para fazer Shiatsu?",
      "resposta": "Não. A sessão de Shiatsu é feita com você vestida, de preferência com roupa leve e confortável que permita movimento. Não se usa óleo nem creme. Se alguém pedir que você se dispa para uma sessão de Shiatsu, não está fazendo Shiatsu."
    },
    {
      "pergunta": "Shiatsu dói?",
      "resposta": "Não deve doer. A pressão é firme e sustentada, e em áreas muito tensas produz um desconforto que a maioria das pessoas reconhece como sendo o ponto certo. Dor aguda, dor que faz prender a respiração ou dor que irradia não fazem parte do trabalho e devem interromper a sessão."
    },
    {
      "pergunta": "Qual a diferença entre Shiatsu e acupuntura?",
      "resposta": "Os dois usam o mesmo mapa de meridianos e pontos, e mudam o instrumento: a acupuntura insere uma agulha fina no ponto, o Shiatsu aplica pressão com polegar, palma, cotovelo ou joelho. A acupuntura tem literatura científica própria para alguns quadros; a do Shiatsu é bem mais fraca."
    },
    {
      "pergunta": "Quantas sessões de Shiatsu são necessárias?",
      "resposta": "Não existe número universal. Para tensão acumulada, é comum combinar de quatro a seis sessões com intervalo semanal ou quinzenal e reavaliar depois. Se nada mudou de forma perceptível em três ou quatro sessões, o mais honesto é reconhecer que o caminho é outro em vez de vender pacote."
    }
  ]
}
---
...
| | Massagem relaxante | Shiatsu |
|---|---|---|
| Mapa | Anatomia muscular | Meridianos e pontos da tradição chinesa |
| Gesto | Deslizamento, amassamento, fricção | Pressão sustentada e perpendicular |
| Duração do contato | Movimento contínuo | Alguns segundos parada em cada ponto |
| Roupa | Retirada, com lençol | Você fica vestida |
| Óleo | Sim | Não |
| Onde | Maca | Em geral futon no chão |
| Instrumentos | Mãos | Polegares, palmas, cotovelos, joelhos, às vezes pés |
| Respiração | Não é o eixo | Central: a pressão acompanha a sua expiração |

O item mais subestimado dessa tabela é o terceiro. Na massagem, a mão está sempre em movimento. No Shiatsu, ela para — e é a permanência que faz o trabalho. Uma pressão que fica cinco ou dez segundos num ponto produz uma resposta diferente da mesma pressão de passagem, e é aí que mora boa parte da estranheza de quem experimenta pela primeira vez achando que ia receber um afago.
...
Agora a parte que este texto precisa dizer com todas as letras, porque quase nenhum concorrente diz.
...
Vale corrigir também um erro que circula muito em português: **o Shiatsu não consta nominalmente da PNPIC.** A lista oficial das práticas reconhecidas pelo Ministério da Saúde não o inclui como prática própria. O que está na política desde 2006 é a medicina tradicional chinesa, campo do qual o Shiatsu é vizinho, e as ampliações de 2017 e 2018 incluíram reiki, quiropraxia, osteopatia, reflexoterapia e imposição de mãos, entre outras — não o Shiatsu. Desfaço essa e outras confusões em [Reiki no SUS](/blog/reiki-no-sus), onde explico por que estar numa política pública nunca foi atestado de eficácia.

:::destaque
O que o Shiatsu oferece com consistência é relaxamento e alívio de tensão muscular, relatado de forma estável por quem faz. O que ele não oferece é comprovação de eficácia para condição nenhuma, porque essa comprovação não existe. Oferecer a prática nesse tamanho é honesto. Oferecê-la como tratamento não é.
:::
...
Não deve doer, e vale detalhar porque a pergunta esconde duas coisas diferentes.
...
:::cuidado
Shiatsu não diagnostica, não trata doença, não substitui consulta, exame ou medicação. Se há dor persistente sem causa esclarecida, o caminho é investigar e cuidar do corpo ao mesmo tempo, não escolher entre as duas coisas.

Se a tensão vem acompanhada de desânimo persistente há semanas, crises de ansiedade frequentes, alteração importante de sono e apetite ou pensamento de morte, procure profissional de saúde mental — psicólogo, psiquiatra, a Unidade Básica de Saúde do seu bairro, um CAPS. Havendo risco imediato, procure atendimento agora ou ligue para o CVV no 188, gratuito e 24 horas.
:::

No consultório, a frase que eu mais escuto depois da primeira sessão é uma variação de "não é o que eu esperava, mas eu queria de novo". É uma boa descrição do Shiatsu. Ele não faz carinho no corpo, faz pergunta ao corpo — e a resposta demora um pouco a aparecer. Se você quiser conversar antes de decidir entre uma prática e outra, o [contato](/contato) está aberto.
