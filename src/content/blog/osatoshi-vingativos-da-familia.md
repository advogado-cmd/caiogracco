---json
{
  "titulo": "Osatoshi de Vingativos da Família: quando o peso não é seu",
  "tituloCurto": "Vingativos da Família",
  "slug": "osatoshi-vingativos-da-familia",
  "resumo": "O trabalho que a tradição da Shinri dirige ao que ela chama de vingativos ligados a uma linhagem. O que são os dois grupos, a regra dos sobrenomes e por que este texto não é para assustar ninguém.",
  "descricao": "Osatoshi de Vingativos da Família: o que a tradição da Shinri descreve, os dois grupos, a regra dos sobrenomes e por que é pré-requisito das ativações.",
  "categoria": "osatoshi",
  "publicadoEm": "2026-08-22",
  "terapias": ["osatoshi"],
  "palavrasChave": [
    "osatoshi de vingativos",
    "vingativos da família",
    "espíritos vingativos",
    "carma familiar osatoshi",
    "maldição de família"
  ],
  "peso": 74,
  "faq": [
    {
      "pergunta": "O que são os vingativos da família na tradição do Osatoshi?",
      "resposta": "A tradição da Shinri descreve dois grupos: os espíritos de pessoas que os antepassados de uma família fizeram sofrer, e os espíritos que guardam rancor contra aquela família. O trabalho se dirige aos dois, não para combatê-los, mas para conduzi-los à reparação e ao encaminhamento que a tradição chama de salvação."
    },
    {
      "pergunta": "Minha família está amaldiçoada?",
      "resposta": "Essa não é a linguagem da tradição, e não é uma boa pergunta para se fazer com medo. A Shinri não trabalha com maldição, culpa ou punição: trabalha com a ideia de espíritos presos que precisam ser encaminhados. Ninguém está condenado a nada, e ninguém é culpado pelo que os antepassados fizeram."
    },
    {
      "pergunta": "Preciso fazer o Osatoshi Individual antes?",
      "resposta": "Este tipo não exige nada antes e pode ser pedido diretamente. Ainda assim, a orientação geral costuma ser começar pelo Osatoshi Individual, que é a base do sistema. Os dois são pré-requisito das ativações da tradição."
    },
    {
      "pergunta": "Quem tem dois sobrenomes precisa de dois pedidos?",
      "resposta": "Sim. A tradição trata cada linhagem separadamente, então há um pedido para a família do pai e outro para a família da mãe. Quem vem de um arranjo com mais famílias envolvidas pode precisar de mais de dois."
    },
    {
      "pergunta": "O Osatoshi de Vingativos da Família trata doença ou depressão?",
      "resposta": "Não. É prática espiritual, sem comprovação científica, que não trata doença física nem transtorno mental e não substitui médico, psicólogo ou medicação. Sofrimento psíquico pede avaliação de profissional de saúde, e isso vale mesmo para quem acompanha a tradição."
    }
  ]
}
---
...
O terceiro é que a leitura espiritual não é a única disponível para o que você está vivendo, e ninguém precisa aderir a ela para ser bem atendido. Coisas que se repetem numa família têm leitura psicológica sólida: comportamento se transmite entre gerações, e segredo de família opera na geração seguinte mesmo quando ninguém conhece o conteúdo. Isso está em [trauma ancestral](/blog/trauma-ancestral) e em [carma familiar](/blog/carma-familiar). As duas leituras podem conviver, e uma não anula a outra.

:::destaque
A tradição descreve dois grupos: espíritos de quem os antepassados fizeram sofrer, e espíritos com rancor contra a família. O trabalho se dirige aos dois com a proposta de encaminhamento, não de expulsão nem de combate. Até três repetições por linhagem, um pedido para cada família de origem, feito à distância. Ninguém é culpado por nada, e nada aqui é urgente.
:::
...
:::cuidado
Nada disto trata doença nem sofrimento psíquico. Se o que está pesando é medo que não cede há semanas, sensação persistente de estar sendo perseguido, desânimo profundo, sono e apetite muito alterados, pensamento de morte, vozes ou visões que os outros não percebem, o primeiro caminho é avaliação de saúde: psicólogo, psiquiatra, a Unidade Básica de Saúde do seu bairro, um CAPS. Havendo risco imediato, procure atendimento agora ou ligue para o [CVV no 188](https://www.cvv.org.br/), gratuito e 24 horas.

Não atendo ninguém nessa situação sem acompanhamento clínico em curso, e encaminhar faz parte do trabalho, não é recusa dele. A distinção entre os dois territórios está em [meu problema é espiritual ou psicológico](/blog/problema-espiritual-ou-psicologico) e os limites de cada prática, no [aviso de cuidado](/aviso-de-cuidado).
:::
...
Existe também a modalidade com relatório escrito ou em áudio. O formato dos atendimentos está na página de [Osatoshi](/terapias/osatoshi).
