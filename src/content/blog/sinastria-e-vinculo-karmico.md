---json
{
  "titulo": "Sinastria, chama gêmea e vínculo kármico: três linguagens",
  "tituloCurto": "Sinastria e vínculo kármico",
  "slug": "sinastria-e-vinculo-karmico",
  "resumo": "O que significa cada expressão dentro da sua própria tradição, por que as três respondem à mesma pergunta e onde termina o símbolo e começa o que se observa na convivência.",
  "descricao": "Sinastria, chama gêmea e vínculo kármico: o que cada expressão quer dizer, o que têm em comum e por que todas tentam responder à mesma pergunta.",
  ...
  "palavrasChave": [
    "sinastria",
    "vínculo kármico",
    "sinastria e chama gêmea",
    "o que é sinastria",
    "conexão kármica no mapa"
  ],
  "peso": 66,
  "faq": [
    {
      "pergunta": "O que é sinastria?",
      "resposta": "É a técnica astrológica em que se comparam os mapas de duas pessoas para descrever a dinâmica entre elas: onde há atração, onde há atrito, onde há peso. É uma leitura simbólica feita por astrólogos, não uma medição. Ela descreve um padrão de relação em linguagem própria e não determina se a relação faz bem a alguém."
    },
    {
      "pergunta": "Vocês fazem leitura de mapa astral ou sinastria?",
      "resposta": "Não. Aqui não se faz mapa astral, leitura de mapa nem sinastria. Quem quiser essa leitura deve procurar um astrólogo. O que se trabalha é o vínculo, não o mapa: a experiência da relação, o que ela sustenta e como se encerra o que ficou aberto."
    },
    {
      "pergunta": "Qual a diferença entre vínculo kármico e sinastria kármica?",
      "resposta": "São vocabulários diferentes para a mesma intuição. Vínculo kármico vem das tradições de reencarnação e fala de pendência entre duas pessoas. Sinastria kármica é um uso astrológico que aponta certos contatos entre mapas (nodos lunares e Saturno, tipicamente) como marcas dessa mesma ideia. Uma é explicação de origem, a outra é um jeito de ler símbolos."
    },
    {
      "pergunta": "Dá para saber pelo mapa se um relacionamento vai dar certo?",
      "resposta": "Nenhum símbolo decide isso, e ninguém deveria prometer previsão de futuro amoroso. O que faz uma relação dar certo ou não é observável na convivência: como as pessoas se tratam, o que fazem com conflito, se há respeito, se a vida de cada uma cresce ou encolhe. Esses dados estão na sua semana, não em um mapa."
    },
    {
      "pergunta": "Por que essa pessoa mexe tanto comigo?",
      "resposta": "É a pergunta por trás das três expressões, e ela tem respostas em várias camadas: história pessoal e o que soa familiar; história de família e o que se repete na linhagem; e a intensidade própria de vínculos imprevisíveis, que fixa mais do que a estabilidade. Nenhuma dessas respostas exige escolher uma tradição, e todas apontam para observar a relação de perto."
    }
  ]
}
---
...
Uma coisa precisa ser dita com todas as letras, e com respeito por quem acredita: essa é a expressão dessa família que mais se presta a justificar permanência em relações que machucam. Quando a dor passa a ser lida como prova de autenticidade do vínculo, sair vira falha espiritual. Isso já custou anos a muita gente, e é o assunto principal de [chama gêmea: sinais, sintomas físicos e o que a expressão diz](/blog/chama-gemea-sinais), que trata inclusive dos tais sintomas físicos e do que eles descrevem do ponto de vista de quem trabalha com corpo.
...
:::destaque
As três expressões respondem à mesma pergunta: por que essa pessoa mexe tanto comigo? Nenhuma delas responde à pergunta seguinte, que é a que decide a sua vida: essa relação, nos últimos seis meses, somou ou subtraiu? A primeira pergunta se responde com símbolo. A segunda, só com observação.
:::
...
Nenhuma dessas observações desmente as tradições: descrevem o mesmo fenômeno por baixo, com a vantagem de sugerir o que fazer amanhã. A versão longa dessa tradução está em [relacionamento kármico ou dependência emocional](/blog/relacionamento-karmico-ou-dependencia-emocional).

:::cuidado
Nenhuma leitura simbólica, seja mapa, sinastria, carma ou chama gêmea, deve ser usada para justificar permanência em relação com controle, ameaça, humilhação, perseguição ou violência de qualquer tipo. Se é o seu caso, o caminho é a rede de proteção: 180, a Central de Atendimento à Mulher, gratuito, sigiloso e 24 horas; 190 em risco imediato.

E se este assunto vem junto com insônia há semanas, perda de apetite, pensamento em repetição que não cede ou pensamentos de morte, procure profissional de saúde: psicólogo, psiquiatra, a Unidade Básica de Saúde do seu bairro ou o CAPS da sua região. O CVV atende no 188, gratuito e 24 horas. Encaminhar faz parte do trabalho, e os limites dele estão no [aviso de cuidado](/aviso-de-cuidado).
:::
