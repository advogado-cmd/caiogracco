---json
{
  "titulo": "Seitai: o que é a terapia manual japonesa e no que difere",
  "tituloCurto": "Seitai: o que é",
  "slug": "seitai-o-que-e",
  "resumo": "O Seitai parte de uma ideia diferente da quiropraxia: em vez de corrigir o corpo, devolver a ele a capacidade de se regular. Como é uma sessão, no que difere e quando não fazer.",
  "descricao": "Seitai: o que é a terapia manual japonesa, como é uma sessão, a diferença para quiropraxia, osteopatia e RPG, e quando ela não é indicada.",
  "categoria": "praticas",
  "publicadoEm": "2026-08-22",
  "terapias": ["seitai", "shiatsu"],
  "palavrasChave": [
    "seitai",
    "seitai o que é",
    "terapia manual japonesa",
    "seitai ou quiropraxia",
    "seitai estala a coluna"
  ],
  "peso": 58,
  "faq": [
    {
      "pergunta": "O que é Seitai?",
      "resposta": "É uma prática manual japonesa organizada no século XX, cuja ideia central é devolver ao corpo a capacidade de se regular sozinho, em vez de impor uma correção de fora. A sessão é feita com a pessoa vestida, com toque, pressão e mobilizações suaves. Não está na PNPIC e praticamente não tem literatura científica — falo dela como tradição e experiência."
    },
    {
      "pergunta": "Seitai estala a coluna?",
      "resposta": "Não. O Seitai não usa manipulação de alta velocidade, que é o movimento rápido responsável pelo estalo característico da quiropraxia. O trabalho é lento, com pressão sustentada e mobilizações suaves acompanhando a respiração. Se alguém oferece Seitai e faz estalo, está misturando técnicas de outra tradição."
    },
    {
      "pergunta": "Qual a diferença entre Seitai e quiropraxia?",
      "resposta": "A quiropraxia trabalha com ajuste articular e correção de desalinhamento, muitas vezes com manipulação rápida. O Seitai parte de outro pressuposto: o desequilíbrio é lido como tentativa de adaptação do corpo, e o trabalho busca criar condições para que ele se reorganize. Um corrige, o outro convida. Além disso, a quiropraxia tem formação regulamentada e literatura científica, e o Seitai não."
    },
    {
      "pergunta": "Preciso tirar a roupa para fazer Seitai?",
      "resposta": "Não. A sessão é feita com você vestida, de preferência com roupa confortável que não aperte. Não se usa óleo nem creme, e o trabalho é conduzido em geral sobre um futon ou colchonete no chão, o que permite ao terapeuta usar o peso do corpo em vez de força."
    },
    {
      "pergunta": "Quando não fazer Seitai?",
      "resposta": "Diante de febre, infecção em curso, fratura recente, dor que apareceu depois de uma queda, osteoporose grave, trombose ou suspeita dela, uso de anticoagulante sem orientação, alteração neurológica como perda de força ou dormência, e em gestação sem liberação de quem acompanha o pré-natal. Nessas situações o caminho é avaliação médica primeiro."
    }
  ]
}
---
...
E, já na segunda linha, a informação que muda tudo e que você merece ter antes de decidir: **o Seitai não consta da Política Nacional de Práticas Integrativas e Complementares e praticamente não existe literatura científica indexada sobre ele.** Não há revisão sistemática, não há ensaio clínico relevante, não há dado. O que existe é uma tradição japonesa com quase um século, uma prática transmitida de professor para aluno e a experiência de quem faz. É desse lugar que falo, e não de outro.
...
Esta é a parte que vale entender, porque ela explica por que uma sessão de Seitai não se parece com nada do que você provavelmente já fez.
...
- **Você fica vestida.** Roupa confortável, que não aperte na cintura e permita movimento. Não se usa óleo nem creme.
- **Em geral no chão.** Sobre futon ou colchonete, o que permite ao terapeuta usar o próprio peso e a mecânica do corpo em vez de força de braço — a mesma lógica do [Shiatsu](/terapias/shiatsu).
- **Começa pela observação.** Antes de tocar, o terapeuta olha: como você está de pé, como respira, o que se move quando você inspira e o que fica parado, como o peso se distribui.
- **O toque é lento.** Palpação ao longo da coluna e das costas, pressão sustentada em pontos que respondem, mobilizações suaves de quadril, ombros e pescoço, sempre acompanhando o ritmo da sua respiração. Nada é rápido.
- **Há pausas em que nada aparenta acontecer.** É onde o terapeuta espera a resposta do corpo. Estranhar isso na primeira vez é normal.
- **Dura entre 40 e 60 minutos**, e a sensação mais comum ao levantar é de corpo mais leve e de respiração mais baixa, chegando ao abdômen em vez de parar no peito.

Muita gente procura Seitai por causa da região que mais concentra queixa no Brasil, e sobre ela escrevi separadamente em [tensão no pescoço e nos ombros](/blog/tensao-no-pescoco-e-ombros).

## Seitai, quiropraxia, osteopatia e RPG: as diferenças

Vale a comparação honesta, inclusive nas partes em que o Seitai sai em desvantagem.
...
A leitura honesta dessa tabela: se o critério for respaldo científico e regulamentação, quiropraxia, osteopatia e RPG estão em posição melhor que o Seitai, e não faz sentido eu fingir o contrário. O que o Seitai oferece é outra coisa — uma abordagem menos intervencionista, com um ritmo que algumas pessoas suportam melhor, especialmente quem já se sentiu maltratada por técnicas mais vigorosas.

:::destaque
Seitai não está na PNPIC, não tem literatura científica que o sustente e não trata doença. É tradição manual japonesa e é experiência de quem pratica. Isso não o torna inútil — torna-o pequeno no que promete. Se você procura uma abordagem regulamentada e com estudos, quiropraxia, osteopatia e fisioterapia são caminhos mais indicados, e dizê-lo faz parte do trabalho.
:::

## "Estala a coluna?" e outros medos legítimos

Essa é a primeira pergunta de quase todo mundo, e o medo por trás dela é razoável.

**Não, o Seitai não estala.** O estalo característico vem da manipulação de alta velocidade e pequena amplitude, que é ferramenta da quiropraxia e de parte da osteopatia — um movimento rápido e curto, feito no fim da amplitude articular. Não faz parte do repertório do Seitai. Se alguém oferece Seitai e aplica estalo, está misturando tradições, o que não é necessariamente errado, mas você tem direito de saber o que está recebendo.
...
:::cuidado
Terapia manual não diagnostica, não trata doença e não substitui investigação. Se você tem dor persistente sem causa esclarecida, o caminho não é escolher entre médico e terapeuta — é fazer os dois, na ordem certa. Escrevi sobre isso em [corpo dói tudo e os exames deram normais](/blog/exames-normais-corpo-doi).

E se a dor no corpo vem junto com desânimo persistente há semanas, crises de ansiedade frequentes, alteração importante de sono e apetite ou pensamento de morte, isso pede profissional de saúde mental antes de qualquer outra coisa. Havendo risco imediato, procure atendimento agora ou ligue para o CVV no 188, gratuito e 24 horas. Os limites de cada prática estão no [aviso de cuidado](/aviso-de-cuidado).
:::

## O que o Seitai não é — e por que digo isso

Não corrige postura de forma permanente. Não realinha coluna. Não trata hérnia de disco, escoliose, artrose nem qualquer condição diagnosticada. Não identifica o que você tem — diagnóstico é ato privativo de profissional de saúde. Não substitui fisioterapia quando há indicação de fisioterapia. Não dispensa exame e não resolve em uma sessão.

Digo isso porque a área em que o [Seitai](/terapias/seitai) circula está cheia de promessa grande, e porque a lista do que uma prática não faz é a informação mais útil que um terapeuta pode dar a quem ainda está decidindo.
...
Se a sua dúvida é entre práticas manuais e o que cada uma faz de diferente, [Shiatsu é massagem?](/blog/shiatsu-e-massagem) trata da prática japonesa mais conhecida e da comparação que quase todo mundo faz errado.
