---json
{
  "titulo": "Corte de laços: como funciona, o que se sente depois e o que não faz",
  "tituloCurto": "Corte de laços: o guia honesto",
  "slug": "corte-de-lacos",
  "resumo": "O que as tradições chamam de vínculo energético, o que um corte de laços se propõe a fazer, o que ele não faz de jeito nenhum e como costumam ser os dias seguintes.",
  "descricao": "Corte de laços energéticos: como funciona, o que se sente nos dias seguintes, quando não fazer e por que ele não apaga sentimento nem substitui decisão.",
  ...
  "palavrasChave": [
    ...
    "como funciona o corte de laços",
    "corte de laços o que sentir depois",
    "corte de laços com ex"
  ],
  "peso": 90,
  "faq": [
    {
      "pergunta": "O que é corte de laços energéticos?",
      "resposta": "É um trabalho espiritual que se propõe a desfazer o que várias tradições descrevem como vínculo energético entre duas pessoas, uma ligação que continuaria ativa mesmo sem convivência. Não existe comprovação científica de que esse vínculo exista ou de que seja possível desfazê-lo. O que existe são relatos de pessoas que se sentiram mais leves depois."
    },
    {
      "pergunta": "O corte de laços faz a pessoa sumir da minha vida?",
      "resposta": "Não. Corte de laços não age sobre a outra pessoa, não a afasta, não a faz mudar de comportamento e não deve ser feito com essa intenção. Ele se dirige a você e ao que você sustenta na relação. Quem quer que alguém saia da própria vida precisa de decisão prática, e às vezes de medida legal."
    },
    {
      "pergunta": "O que se sente depois de um corte de laços?",
      "resposta": "Os relatos mais comuns nos primeiros dias são sonolência, sonhos vívidos, vontade de chorar sem motivo claro, um cansaço parecido com o de quem chorou muito, e depois uma sensação de espaço. Algumas pessoas não sentem nada de diferente. Nenhuma dessas reações é prova de que algo aconteceu, e a ausência delas também não prova o contrário."
    },
    {
      "pergunta": "Quando não fazer corte de laços?",
      "resposta": "Evite quando o que está em jogo é uma decisão prática que você ainda não tomou, quando existe violência ou risco em curso, quando a expectativa é que a outra pessoa mude, e quando você está em crise psíquica aguda. Em nenhuma dessas situações o trabalho espiritual é o recurso adequado como primeira medida."
    },
    {
      "pergunta": "Quantas vezes é preciso fazer o corte de laços?",
      "resposta": "Não existe número correto, e desconfie de quem oferece um pacote fechado como se houvesse. Vínculos com pessoas com quem você convive não se resolvem de uma vez porque a convivência continua alimentando a relação. O corte, nesses casos, é acompanhamento, não evento."
    }
  ]
}
---
...
**Fechar o canal.** É a parte a que o nome se refere. Na prática do [Osatoshi](/terapias/osatoshi) e em trabalhos conduzidos com [Reiki](/terapias/reiki), o corte não é um gesto agressivo contra alguém. É um encerramento dirigido a você, ao que você segura.

Vale a ressalva sobre o Reiki: está reconhecido na política nacional de práticas integrativas desde 2017, o que não é o mesmo que comprovação de eficácia, já que a [revisão Cochrane de 2015 sobre depressão e ansiedade](https://www.cochrane.org/CD006833/DEPRESSN_reiki-for-depression-and-anxiety) concluiu que os estudos disponíveis são poucos e de baixa qualidade. O Osatoshi, por sua vez, não é prática de saúde. É caminho espiritual da tradição japonesa da Shinri, e é assim que precisa ser apresentado.

:::destaque
O corte de laços não é feito contra a outra pessoa. É feito com o que **você** sustenta. Essa distinção parece pequena e muda tudo: define quem é o objeto do trabalho, o que se pode esperar dele e por que ele nunca funciona como instrumento de controle sobre alguém.
:::
...
:::cuidado
Se, ao pensar nessa relação, você tem crises de ansiedade frequentes, não consegue dormir há semanas, perdeu o apetite, parou de trabalhar ou tem pensamentos de morte, procure um profissional de saúde antes de qualquer trabalho espiritual. Psicólogo, psiquiatra, a Unidade Básica de Saúde do seu bairro, um CAPS. Havendo pensamento de morte ou risco imediato, procure atendimento agora ou ligue para o [CVV](https://www.cvv.org.br/) no 188, gratuito e 24 horas.

Se existe violência, ameaça ou perseguição, o caminho é a rede de proteção: [Central de Atendimento à Mulher pelo 180](https://www.gov.br/mdh/pt-br/ligue180), delegacia, e apoio de pessoas próximas. Nenhum trabalho energético substitui isso. Os limites da prática estão no [aviso de cuidado](/aviso-de-cuidado).
:::
...
Vale ainda separar duas queixas que costumam se confundir. Sentir peso ao lidar com uma pessoa específica é diferente de absorver o clima de todo ambiente. Se for o segundo caso, [sinto a energia das pessoas](/blog/sinto-a-energia-das-pessoas) e [proteção espiritual como rotina](/blog/protecao-espiritual-rotina) tratam de outro tipo de trabalho, mais parecido com higiene diária do que com encerramento. E se o que você procura é o cuidado mais amplo do ambiente e de si, [limpeza espiritual](/blog/limpeza-espiritual) explica a diferença entre um gesto simbólico e um trabalho conduzido.
