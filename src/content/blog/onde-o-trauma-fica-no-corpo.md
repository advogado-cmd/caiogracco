---json
{
  "titulo": "Onde o trauma fica guardado no corpo: o que a mão encontra",
  "tituloCurto": "Onde o trauma fica no corpo",
  "slug": "onde-o-trauma-fica-no-corpo",
  "resumo": "Susto e ameaça deixam marca no jeito de respirar, na mandíbula, no diafragma, nos ombros e no quadril. O que um terapeuta manual encontra ao tocar alguém que viveu isso.",
  "descricao": "Trauma no corpo: por que a memória de ameaça vira padrão de respiração e tensão, o que o toque encontra e por que terapia corporal não é psicoterapia.",
  "categoria": "corpo",
  "publicadoEm": "2026-08-22",
  "terapias": ["shiatsu", "seitai", "auriculoterapia"],
  "palavrasChave": [
    "onde o trauma fica no corpo",
    "trauma guardado no corpo",
    "memória do trauma no corpo",
    "tensão emocional no diafragma",
    "terapia corporal para trauma"
  ],
  "peso": 84,
  "faq": [
    {
      "pergunta": "O trauma fica mesmo guardado no corpo?",
      "resposta": "O que se observa com clareza é que uma experiência de ameaça deixa padrões: respiração curta, mandíbula travada, ombros elevados, quadril rígido, sobressalto fácil. Chamar isso de memória guardada é uma metáfora útil, não uma descrição fisiológica comprovada. O padrão é real e observável; a explicação de como ele se fixa ainda é assunto aberto."
    },
    {
      "pergunta": "Massagem ou Shiatsu ajudam a soltar trauma?",
      "resposta": "Podem ajudar a soltar tensão, e isso costuma trazer alívio real. Soltar tensão não é o mesmo que tratar trauma. O trabalho com a experiência traumática em si, com o que aconteceu, o que ficou e como isso organiza a vida hoje, é da psicoterapia, com profissional de saúde mental habilitado."
    },
    {
      "pergunta": "Terapia corporal trata estresse pós-traumático?",
      "resposta": "Não. Transtorno de estresse pós-traumático é um quadro de saúde mental com critérios próprios e tratamentos com respaldo, conduzidos por psicólogo e psiquiatra. Uma sessão de toque pode acompanhar esse tratamento e oferecer alívio de tensão, nunca substituí-lo."
    },
    {
      "pergunta": "Por que eu choro em sessão de massagem sem motivo?",
      "resposta": "É comum e não tem nada de errado. Quando a musculatura afrouxa e a respiração se aprofunda, o estado de alerta baixa, e o que estava sendo segurado tem espaço para aparecer. Não é sinal de que algo foi descoberto ou liberado. É o corpo saindo da guarda por alguns minutos."
    },
    {
      "pergunta": "A medicina chinesa diz que cada emoção fica em um órgão. Isso é científico?",
      "resposta": "Não. A correspondência entre emoções e órgãos é um sistema simbólico de uma tradição médica com séculos de uso, e faz sentido dentro da lógica dela. Não corresponde à fisiologia como a biomedicina a descreve, e apresentá-la como se correspondesse seria desonesto."
    }
  ]
}
---
...
- **A mandíbula em trabalho constante.** Masseter endurecido, dor ao toque leve, muitas vezes com histórico de [ranger os dentes à noite](/blog/bruxismo) ou de estalo ao abrir a boca.
...
:::destaque
O que o toque encontra é o presente: um corpo em estado de defesa agora. O que o corpo faz é o passado. Uma sessão pode trabalhar o primeiro com bastante consistência. O segundo é território de psicoterapia, e confundir os dois é o erro mais caro nesse assunto.
:::
...
O [Shiatsu](/terapias/shiatsu) é a prática que uso com mais frequência nesses casos. E, ao contrário do que muito texto repete, ele não consta nominalmente da [lista oficial de práticas integrativas do Ministério da Saúde](https://www.gov.br/saude/pt-br/composicao/saps/pics). A evidência de eficácia é fraca, embora os relatos de relaxamento e de alívio de tensão sejam consistentes. O [Seitai](/terapias/seitai) não consta da PNPIC e praticamente não tem literatura científica; falo dele como tradição japonesa e como experiência, sem estender isso. A [auriculoterapia](/terapias/auriculoterapia) está na PNPIC dentro da medicina tradicional chinesa e o Ministério da Saúde mantém formação nacional para a Atenção Primária. Só que reconhecimento em política pública não é o mesmo que comprovação de eficácia, e a evidência disponível é fraca.
...
Sobre a parte que é do quadril e da nuca, o que se faz na prática está descrito em [tensão no pescoço e nos ombros](/blog/tensao-no-pescoco-e-ombros). Quando o que aperta é o peito e o fôlego, o caminho passa por [respiração curta](/blog/respiracao-curta). E quando o padrão parece anteceder a própria biografia, repetindo o que já existia na família antes de você, o assunto é outro: escrevi sobre ele em [trauma ancestral](/blog/trauma-ancestral).

:::cuidado
Terapia corporal não é psicoterapia. Se você viveu violência, abuso, acidente grave, perda súbita ou qualquer episódio que continua voltando em pesadelo, lembrança invasiva, sobressalto ou entorpecimento, o cuidado principal é com profissional de saúde mental: psicólogo, psiquiatra, CAPS ou a Unidade Básica de Saúde do seu bairro. Transtorno de estresse pós-traumático tem tratamento com respaldo, e ele não é feito com as mãos numa maca.

Se houver pensamento de morte, de se machucar ou sensação de que não dá mais, procure ajuda agora: emergência, SAMU 192 ou o [CVV pelo 188](https://www.cvv.org.br/), que atende 24 horas, é gratuito e sigiloso. Uma sessão de toque pode caminhar ao lado desse cuidado, e é assim que ela deve ser oferecida. Os limites disso estão no [aviso de cuidado](/aviso-de-cuidado) deste site.
:::
...
Se os exames já vieram normais e a dor continua, o caminho que descrevo em [corpo dói tudo e os exames deram normais](/blog/exames-normais-corpo-doi) segue a mesma lógica. Isso muda a pergunta que vale a pena fazer. Não é "como eu tiro o trauma do meu corpo", porque essa operação não existe do jeito que se anuncia por aí. É "o que este corpo ainda está defendendo, e do que ele precisa para poder baixar a guarda com segurança". A segunda pergunta tem resposta prática, e ela costuma envolver mais de um tipo de cuidado ao mesmo tempo.
