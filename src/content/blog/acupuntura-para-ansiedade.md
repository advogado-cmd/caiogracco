---json
{
  "titulo": "Acupuntura para ansiedade: o que a evidência mostra e o que não",
  "tituloCurto": "Acupuntura para ansiedade",
  "resumo": "A acupuntura é a mais respaldada das práticas integrativas e, mesmo assim, a evidência para ansiedade é fraca. O que esperar de verdade, quantas sessões e o que ela não faz.",
  "slug": "acupuntura-para-ansiedade",
  "descricao": "Acupuntura para ansiedade: como é a sessão, se dói, quantas sessões antes de avaliar e o que a ciência realmente sustenta. Sem promessa.",
  "categoria": "praticas",
  "publicadoEm": "2026-08-22",
  "terapias": ["acupuntura-sistemica", "auriculoterapia"],
  "palavrasChave": [
    "acupuntura para ansiedade",
    "acupuntura ansiedade funciona",
    "quantas sessões de acupuntura para ansiedade",
    "acupuntura dói",
    "acupuntura ansiedade evidência"
  ],
  "peso": 65,
  "faq": [
    {
      "pergunta": "Acupuntura funciona para ansiedade?",
      "resposta": "Muita gente relata sono melhor, corpo menos travado e menos reatividade no dia a dia, e a acupuntura é a prática integrativa com melhor respaldo científico no geral. Mas a evidência específica para ansiedade é fraca: os estudos são pequenos, heterogêneos e com alto risco de viés. Ela pode acompanhar o cuidado principal, não ocupar o lugar dele."
    },
    {
      "pergunta": "Quantas sessões de acupuntura para ansiedade?",
      "resposta": "Uma referência honesta é de seis a oito sessões, com intervalo semanal, antes de avaliar. Uma sessão isolada não informa quase nada, porque relaxar por algumas horas depois de deitar em silêncio com agulhas não distingue efeito da prática de efeito do descanso. O que se avalia é a semana, não a saída da maca."
    },
    {
      "pergunta": "Acupuntura dói?",
      "resposta": "A agulha de acupuntura é filiforme, muito mais fina que a de injeção, e a inserção costuma passar quase despercebida. O que se sente depois é outra coisa: um peso, um formigamento ou um calor local que a tradição chama de deqi. Dor aguda, ardência forte ou dor que irradia não fazem parte do trabalho e devem ser avisadas na hora."
    },
    {
      "pergunta": "Fiz três sessões de acupuntura e não senti nada. É normal?",
      "resposta": "É comum e não significa fracasso nem que você não responde. Três sessões costumam ser pouco para uma queixa que se instalou ao longo de anos. Vale conversar com quem atende, revisar a leitura do caso e combinar um prazo de avaliação claro. O que não vale é seguir por meses sem nenhum critério de parada."
    },
    {
      "pergunta": "Posso parar o antidepressivo se fizer acupuntura?",
      "resposta": "Não. Ajuste ou suspensão de medicação psiquiátrica é decisão exclusiva de quem prescreveu, feita com acompanhamento, porque a retirada abrupta tem risco real. Terapeuta que sugere reduzir seu remédio está agindo fora do que lhe cabe, e isso é motivo suficiente para procurar outro profissional."
    }
  ]
}
---
...
:::destaque
Avalie pela semana, não pela saída da sessão. Combine desde o começo quantas sessões antes de reavaliar, e o que exatamente vocês vão olhar. Se ao fim desse prazo nada mudou de forma perceptível, parar é a resposta correta, e um terapeuta que diz isso está cuidando melhor de você do que um que oferece mais dez.
:::
...
A acupuntura está na [Política Nacional de Práticas Integrativas e Complementares](https://www.gov.br/saude/pt-br/composicao/saps/pics) desde 2006, dentro da medicina tradicional chinesa, e é a mais estudada das oito práticas que atendo. Sua afirmação mais firme na literatura é bem delimitada: a [revisão Cochrane conduzida por Linde e colaboradores](https://www.cochrane.org/CD001218/SYMPT_acupuncture-preventing-migraine-attacks) (CD001218) indica **certeza moderada de benefício da acupuntura na prevenção de enxaqueca**, com pelo menos seis sessões de tratamento.
...
:::cuidado
Acupuntura não trata transtorno de ansiedade, não impede crise de pânico e não substitui psicoterapia ou medicação. Ela pode acompanhar esse cuidado, e é assim que faz sentido oferecê-la.

Se há desânimo persistente por semanas, crises frequentes, alteração importante de sono e apetite, ou se a ansiedade já limita para onde você vai e o que você faz, procure profissional de saúde mental: psicólogo, psiquiatra, a Unidade Básica de Saúde do seu bairro, um CAPS. Havendo pensamento de morte ou vontade de se machucar, o [CVV](https://www.cvv.org.br/) atende no **188**, gratuito, sigiloso e 24 horas, também por chat. Encaminhar faz parte deste trabalho, não é o contrário dele.

Sobre remédio, uma linha sem ambiguidade: **nunca reduza nem suspenda medicação psiquiátrica por conta própria ou por indicação de terapeuta.** A retirada abrupta tem risco real, e quem sugere isso a você está agindo fora do que lhe cabe. Trate como sinal de alerta e procure outro profissional. Os limites do que faço estão no [aviso de cuidado](/aviso-de-cuidado).
:::

## Quando faz sentido, e quando o caminho é outro

Faz sentido quando o cuidado principal já está em ordem e sobra um corpo em estado de alerta para cuidar: ombros elevados, mandíbula travada, respiração alta, sono ruim, digestão desregulada. Esse território é legítimo e é onde a [acupuntura sistêmica](/terapias/acupuntura-sistemica) costuma ser mais útil, não como tratamento da ansiedade, mas como manejo do corpo que vive nela. Se a sua queixa aparece sobretudo como sintoma físico, o mecanismo está descrito em [ansiedade no corpo](/blog/ansiedade-no-corpo), e a parte noturna, em [insônia: o que fazer](/blog/insonia-o-que-fazer).
...
Como as sessões são presenciais e espaçadas, muita gente combina agulhas com [auriculoterapia](/terapias/auriculoterapia), que mantém pontos atuando na orelha entre um encontro e outro. Não é fazer duas coisas para cobrar duas vezes, e explico a lógica em [acupuntura ou auriculoterapia](/blog/acupuntura-ou-auriculoterapia).
