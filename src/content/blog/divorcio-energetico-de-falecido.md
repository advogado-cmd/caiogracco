---json
{
  "titulo": "Divórcio Energético de falecido: quando a saudade trava a vida",
  "tituloCurto": "Divórcio Energético de falecido",
  "slug": "divorcio-energetico-de-falecido",
  "resumo": "O trabalho que a tradição da Shinri propõe para o vínculo com quem morreu, pessoa ou animal, o pré-requisito que quase ninguém explica e o que ele não faz pelo luto.",
  "descricao": "Divórcio Energético de falecido: o que a tradição propõe quando a saudade trava a vida, o pré-requisito do pedido e por que luto tem cuidado próprio.",
  "categoria": "osatoshi",
  "publicadoEm": "2026-08-22",
  "terapias": ["osatoshi"],
  "palavrasChave": [
    "divórcio energético de falecido",
    "vínculo com quem morreu",
    "saudade que não passa",
    "luto que trava a vida",
    "corte de laços com falecido"
  ],
  "peso": 66,
  "faq": [
    {
      "pergunta": "O que é o Divórcio Energético de falecido?",
      "resposta": "É a modalidade da tradição japonesa da Shinri voltada ao vínculo entre uma pessoa viva e alguém que morreu, seja uma pessoa ou um animal de estimação. É prática espiritual, sem comprovação científica, e não é tratamento para luto nem para sofrimento psíquico."
    },
    {
      "pergunta": "Existe algum pré-requisito para esse trabalho?",
      "resposta": "Sim, e é uma regra concreta: quem morreu precisa já ter recebido o Osatoshi de Falecido. Quando isso ainda não aconteceu, os dois pedidos são feitos juntos. Não é detalhe burocrático. Na lógica da tradição, o encaminhamento de quem partiu vem antes do desligamento de quem ficou."
    },
    {
      "pergunta": "Fazer esse trabalho significa esquecer quem morreu?",
      "resposta": "Não, e essa é a preocupação mais comum de quem procura. O que a tradição propõe não é apagar a pessoa nem a memória dela. É desfazer o que ela descreve como uma ligação que mantém quem ficou parado. Continuar amando quem morreu não depende de continuar travado."
    },
    {
      "pergunta": "Serve para um animal de estimação que morreu?",
      "resposta": "Serve. A tradição trata o vínculo com um animal falecido dentro da mesma modalidade, com a mesma lógica de pedido. Quem já perdeu um bicho com quem conviveu por muitos anos não precisa que ninguém explique por que esse luto é grande."
    },
    {
      "pergunta": "Quando o caso é de procurar ajuda profissional?",
      "resposta": "Quando o luto passa de muitos meses sem nenhuma mudança, quando você parou de trabalhar, de comer ou de sair, quando a vida ficou organizada inteira em torno da ausência, ou quando aparecem pensamentos de morte. Isso tem nome clínico, tem tratamento e é assunto de profissional de saúde mental. Havendo risco imediato, ligue para o CVV no 188."
    }
  ]
}
---
...
Na leitura da tradição, há aí um vínculo ativo. Na leitura da psicologia, há um luto que não encontrou o próprio curso. Não vou fingir que os dois vocabulários são a mesma coisa, e não vou escolher um deles pelo leitor. Vou dizer o que me parece justo: eles apontam para a mesma experiência, e quem trabalha com o campo espiritual erra feio quando ignora o outro lado. Sobre o que a ausência faz com quem continua, escrevi em [o luto de quem fica](/blog/luto-de-quem-fica).

:::destaque
Esse trabalho não se propõe a fazer você esquecer, nem a diminuir o tamanho de quem morreu. A ideia, no vocabulário da tradição, é justamente o contrário: desfazer o que prende para que a lembrança possa ocupar o lugar de lembrança, e não o de âncora. Continuar amando alguém que morreu não exige continuar travado.
:::
...
:::cuidado
Luto que não passa e trava a vida tem nome clínico e tem tratamento. Quando a dor mantém a mesma intensidade do primeiro mês depois de muitos meses, quando a vida inteira se reorganizou em torno da ausência, quando você parou de comer, de dormir, de trabalhar ou de ver gente, isso não é falta de fé nem fraqueza de caráter. É sofrimento que merece acompanhamento profissional.

Procurar psicólogo ou psiquiatra não é deslealdade com quem morreu. Não é seguir em frente rápido demais, não é apagar ninguém, não é trair a memória. É cuidar da pessoa que continuou viva, que era, provavelmente, o que quem partiu iria querer.

Se houver pensamentos de morte ou vontade de não estar mais aqui, procure atendimento agora. O [CVV](https://www.cvv.org.br/) atende no 188, de graça, 24 horas por dia, todos os dias. Os limites desta prática estão no [aviso de cuidado](/aviso-de-cuidado).
:::

## Como o pedido é feito

O trabalho é conduzido à distância, como todas as modalidades de [Osatoshi](/terapias/osatoshi). O que se pede: os dados de quem morreu, com nome, datas e circunstâncias na medida em que você tiver, os dados de quem faz o pedido, e o relato do vínculo. Para um animal, o nome basta quando não há mais nada.
...
Quem chega com esse pedido raramente chega só com ele. Duas leituras costumam ajudar a situar o assunto: [o Osatoshi de Falecido](/blog/osatoshi-de-falecido), que explica a regra dos cinquenta dias e o que a tradição propõe para quem partiu, e o [Divórcio Energético de uma pessoa](/blog/divorcio-energetico), que trata da mesma família de trabalho quando o vínculo é com alguém vivo, inclusive com a orientação, que vale registrar, de que romper nunca é o primeiro recurso.

Se o que pesa é mais amplo do que uma ausência específica, como a casa que ficou estranha ou o corpo que não descansa, [energia pesada em casa](/blog/energia-pesada-em-casa) trata de outro tipo de queixa, com outro tipo de trabalho.
