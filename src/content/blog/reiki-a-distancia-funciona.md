---json
{
  "titulo": "Reiki à distância funciona? O que muda em relação ao presencial",
  "tituloCurto": "Reiki à distância funciona?",
  "slug": "reiki-a-distancia-funciona",
  "resumo": "A resposta honesta sobre Reiki à distância: como a tradição explica o envio, como é combinado na prática, o que muda em relação ao presencial e o que a evidência científica permite afirmar.",
  "descricao": "Reiki à distância funciona? Como é feito o envio, o que muda em relação ao presencial, o que a evidência mostra e por que não sentir nada é comum.",
  "categoria": "praticas",
  ...
  "palavrasChave": [
    ...
    "reiki a distancia",
    "como funciona reiki à distância",
    "reiki online",
    "diferença reiki presencial e à distância"
  ],
  "peso": 75,
  "faq": [
    {
      "pergunta": "Reiki à distância funciona mesmo?",
      "resposta": "A resposta honesta é que não há como afirmar isso com base científica. A evidência sobre Reiki é insuficiente, e a revisão Cochrane de 2015 sobre depressão e ansiedade concluiu que os estudos existentes são poucos e de baixa qualidade. O que existe são relatos consistentes de relaxamento e descanso, e é assim que a prática deve ser oferecida."
    },
    {
      "pergunta": "Preciso acreditar para o Reiki à distância funcionar?",
      "resposta": "Não se exige crença. Quem procura vem de todo tipo de posição, inclusive de bastante ceticismo, e não há teste de fé antes. O que a experiência costuma pedir é disposição para parar por alguns minutos, o que é diferente de acreditar em alguma coisa."
    },
    {
      "pergunta": "O que eu preciso fazer na hora do Reiki à distância?",
      "resposta": "Combina-se um horário e você fica onde estiver, de preferência sem interrupção, deitada ou sentada. Não precisa meditar, não precisa se concentrar, não precisa ficar acordada. Muita gente dorme, e isso não é problema."
    },
    {
      "pergunta": "Não senti nada durante o Reiki à distância. Funcionou?",
      "resposta": "Não sentir nada é comum e não indica nada em particular. A sensação durante a sessão não é medida de resultado, e há quem só perceba diferença no sono da noite seguinte, ou em nada. Nenhum terapeuta sério vai dizer que você fez errado."
    },
    {
      "pergunta": "Reiki à distância é igual ao presencial?",
      "resposta": "Dentro da tradição, o método é o mesmo e a distância não é considerada obstáculo. Na experiência, muda bastante: não há toque, não há sala nem deslocamento, e o efeito de presença de outra pessoa no ambiente desaparece. Para muita gente essa diferença pesa, e é legítimo preferir o presencial."
    }
  ]
}
---
...
O que se pode dizer sem exagero é que a distância não é o ponto fraco do Reiki. O ponto em aberto é o Reiki inteiro — presencial incluído. Quem afirma que o presencial é comprovado e o remoto é duvidoso está aplicando um rigor seletivo que não se sustenta. E quem usa a presença do Reiki na política pública brasileira como se fosse selo de eficácia está fazendo outra confusão, que desfaço em [Reiki no SUS](/blog/reiki-no-sus).

## Como é combinado na prática

A parte concreta costuma surpreender pela simplicidade.

1. **Uma conversa antes.** Por mensagem ou chamada. Você conta o que está acontecendo, o que quer trabalhar, o que está tomando, se há acompanhamento médico ou psicológico em curso. Essa conversa não é formalidade — é onde se decide se o Reiki faz sentido para você agora, ou se o caminho é outro.
2. **Um horário combinado.** Em geral entre 20 e 40 minutos, num momento em que você possa ficar sem interrupção. Fim de tarde e antes de dormir funcionam bem para a maioria das pessoas, porque não há nada depois.
3. **O que você faz.** Nada de especial. Deitada ou sentada, roupa confortável, celular no silencioso. Não precisa meditar, não precisa esvaziar a mente, não precisa se concentrar em nada. Se dormir, tudo bem — acontece muito.
4. **A devolutiva.** Depois, uma troca curta sobre o que foi percebido e sobre o que você sentiu, se sentiu.
...
Vale registrar como relato, que é o que é — não como efeito esperado, porque não há efeito esperado.
...
A diferença que pesa a favor é também prática: o remoto elimina a parte mais atrapalhada do presencial, que é ter que voltar para o mundo dez minutos depois de relaxar. Terminar uma sessão já em casa, já de pijama, com a cama do lado, não é pouco para quem dorme mal. Sobre isso, [insônia: o que fazer quando a noite virou inimiga](/blog/insonia-o-que-fazer) trata do que ajuda de fato e do que só adia o problema.

:::destaque
A pergunta "funciona?" não tem resposta científica favorável, e ninguém honesto vai te dar uma. O que dá para dizer é o seguinte: a evidência é insuficiente e de baixa qualidade; os relatos de relaxamento e de sono melhor são consistentes; e o [Reiki](/terapias/reiki) à distância, dentro da tradição, é praticado com o mesmo método do presencial. Se você procura descanso e uma pausa conduzida, faz sentido. Se procura tratamento para uma doença, não é aqui.
:::
...
:::cuidado
Reiki não trata doença, não substitui medicação, consulta ou psicoterapia, e não deve ser a primeira parada diante de sintoma novo ou de sofrimento psíquico intenso. Se há desânimo persistente há semanas, crises de ansiedade frequentes, alteração importante de sono e apetite ou pensamento de morte, procure profissional de saúde — psicólogo, psiquiatra, a Unidade Básica de Saúde do seu bairro, um CAPS. Havendo risco imediato, procure atendimento agora ou ligue para o CVV no 188, gratuito e 24 horas.

Cuidado complementar caminha ao lado do tratamento, nunca no lugar dele. Os limites de cada prática estão no [aviso de cuidado](/aviso-de-cuidado).
:::
