---json
{
  "titulo": "O que é egrégora, e por que ela pesa mais do que parece",
  "tituloCurto": "O que é egrégora",
  "slug": "o-que-e-egregora",
  "resumo": "Empresa, igreja, família, time, grupo de WhatsApp, curso: toda coletividade forma um campo próprio. O que é egrégora, como ela se forma e o que acontece com quem pertence a grupos que se contradizem.",
  "descricao": "O que é egrégora: definição clara, exemplos do dia a dia, o que a tradição diz que ela faz com quem participa e como se desligar de uma.",
  "categoria": "espiritual",
  "publicadoEm": "2026-08-22",
  "terapias": ["osatoshi"],
  "palavrasChave": [
    "o que é egrégora",
    "egrégora significado",
    "egrégora de empresa",
    "como se desligar de uma egrégora",
    "egrégora familiar"
  ],
  "peso": 60,
  "faq": [
    ...
    },
    {
      ...
      "resposta": "Como conceito espiritual, é uma leitura de tradição, sem comprovação científica e sem mecanismo demonstrado. Como descrição de fenômeno de grupo, ela nomeia algo que qualquer pessoa reconhece: ambientes têm clima próprio e grupos moldam comportamento. As duas leituras não precisam brigar."
    },
    {
      "pergunta": "Dá para pertencer a muitas egrégoras ao mesmo tempo?",
      "resposta": "Sim, e é o que acontece com praticamente todo mundo. O problema apontado pela tradição não é a quantidade, e sim a contradição: pertencer a grupos que exigem coisas opostas costuma produzir uma sensação constante de estar em falta com alguém."
    },
    {
      "pergunta": "Como se desliga de uma egrégora?",
      "resposta": "Na prática concreta, saindo: encerrando o vínculo, deixando o grupo, parando de participar. No plano da tradição, existem trabalhos voltados a vínculos que continuam pesando depois da saída formal. Um não substitui o outro."
    },
    {
      "pergunta": "Qual a diferença entre egrégora e carma familiar?",
      "resposta": "Egrégora é o campo formado por um grupo do qual você participa agora. Carma familiar, no vocabulário dessas tradições, é o que vem pela linhagem e chegou até você já formado. São coisas diferentes, ainda que a família seja, ela mesma, uma egrégora."
    }
  ]
}
---
...
A tradição japonesa da [Shinri](/terapias/osatoshi) usa a palavra nesse mesmo sentido e a trata como assunto de trabalho próprio. Para ela, egrégoras existem em empresa, em instituição religiosa, em família, em grupo profissional, em ambiente acadêmico. Cada uma tem características próprias, e uma pessoa está ligada a todas as que participa.
