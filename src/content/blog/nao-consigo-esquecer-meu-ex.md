---json
{
  "titulo": "Não consigo esquecer meu ex: por que o vínculo continua",
  "tituloCurto": "Não consigo esquecer meu ex",
  "slug": "nao-consigo-esquecer-meu-ex",
  "resumo": "Meses depois do fim, a pessoa ainda ocupa o seu dia. Por que o cérebro trata separação como abstinência, o que prolonga o vínculo e quanto tempo isso costuma levar de verdade.",
  "descricao": "Não consigo esquecer meu ex: por que a separação dói como abstinência, o que prolonga o vínculo, quanto tempo leva e o que ajuda a fechar de verdade.",
  "categoria": "relacionamentos",
  "publicadoEm": "2026-08-22",
  "terapias": ["osatoshi", "reiki"],
  "palavrasChave": [
    "não consigo esquecer meu ex",
    "como esquecer um ex",
    "vínculo com ex não passa",
    "por que ainda penso no meu ex",
    "laço energético com ex"
  ],
  "peso": 82,
  "faq": [
    {
      "pergunta": "Por que eu não consigo esquecer meu ex mesmo depois de tanto tempo?",
      "resposta": "Porque esquecer não é o que acontece. O que acontece é o vínculo perder intensidade aos poucos, e isso leva tempo, principalmente quando a história terminou sem explicação, quando ainda existe contato ou quando você acompanha a vida da pessoa pelas redes. Continuar pensando não significa que era a pessoa certa, nem que você fez algo errado."
    },
    {
    ...
    },
    {
      ...
      "resposta": "Saudade tem endereço: você sente falta de uma pessoa concreta, de coisas específicas, e consegue tocar a vida ao lado disso. Vínculo que não se desfaz ocupa espaço: pensamento repetitivo, checagem de redes, reação física ao nome, dificuldade de investir em qualquer outra coisa. Um é sentimento, o outro é funcionamento."
    },
    {
      "pergunta": "O corte de laços faz esquecer o ex?",
      "resposta": "Não. Corte de laços não apaga sentimento, não faz a pessoa sumir e não substitui a decisão de parar de procurar. É um trabalho dirigido a você e ao que você sustenta na relação. Quem espera que ele funcione como apagador de memória vai se frustrar."
    },
    {
