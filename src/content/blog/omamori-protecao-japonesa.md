---json
{
  "titulo": "Omamori: o que é a proteção japonesa e o que ela não é",
  "tituloCurto": "Omamori: a proteção japonesa",
  "slug": "omamori-protecao-japonesa",
  "resumo": "Os amuletos de tecido vendidos em templos japoneses, o omamori próprio da tradição da Shinri, e a diferença honesta entre carregar uma proteção e sustentar uma prática.",
  "descricao": "Omamori: o que é o amuleto japonês, como funciona na cultura popular do Japão, o que a tradição da Shinri propõe e por que proteção não é blindagem.",
  ...
  "palavrasChave": [
    "omamori",
    "omamori significado",
    "amuleto japonês de proteção",
    "proteção espiritual japonesa",
    "omamori shinri"
  ],
  "peso": 52,
  "faq": [
    {
      "pergunta": "O que é um omamori?",
      "resposta": "É o amuleto de proteção da tradição japonesa: uma pequena bolsa de tecido, costurada e fechada, obtida em templos e santuários do Japão. Cada tipo é dedicado a um propósito: estudos, viagem, saúde, trabalho, gestação. Faz parte da cultura popular japonesa há séculos."
    },
    {
      "pergunta": "Pode abrir um omamori?",
      "resposta": "A tradição japonesa diz que não. O amuleto é feito para permanecer fechado, e abri-lo é considerado esvaziar o sentido do objeto. É uma convenção cultural bastante consolidada, respeitada inclusive por quem não é religioso."
    },
    {
      "pergunta": "O omamori da Shinri é o mesmo dos templos japoneses?",
      "resposta": "Não. São coisas distintas. Os omamori de templos e santuários fazem parte da cultura popular japonesa e podem ser obtidos por qualquer visitante. O omamori da Shinri é próprio dessa associação, criado dentro dela, e obtido apenas pelos canais da própria organização."
    },
    {
      "pergunta": "Posso copiar ou imprimir o omamori da Shinri?",
      "resposta": "Não. A própria tradição desaconselha expressamente copiar ou distribuir o conteúdo do seu omamori, e por isso ele não é reproduzido, descrito nem ensinado em nenhum lugar deste site. Quem oferece cópias na internet está desrespeitando a orientação da tradição de onde a coisa vem."
    },
    {
      "pergunta": "Amuleto protege mesmo?",
      "resposta": "Não há comprovação de nenhum tipo, e nenhum objeto blinda ninguém de doença, acidente ou perda. O que amuletos comprovadamente fazem é funcionar como lembrete e como marcação de intenção. Modesto, mas não é pouco."
    }
  ]
}
---
...
A [Shinri](/terapias/osatoshi) é uma associação espiritual japonesa contemporânea, e dentro dela existe um omamori próprio, criado por seu fundador. Ele não é o mesmo objeto dos templos e santuários, não é vendido a turistas e não circula em loja.
...
:::destaque
Duas coisas diferentes com o mesmo nome. Os omamori de templos e santuários japoneses são cultura popular, acessíveis a qualquer visitante, com convenções próprias de uso e renovação. O omamori da Shinri é interno à associação, obtido só pelos canais dela, e a própria tradição desaconselha copiar ou distribuir seu conteúdo, motivo pelo qual ele não é reproduzido nem descrito aqui.
:::
...
:::cuidado
Amuletos e objetos de proteção não previnem, não tratam e não substituem cuidado médico ou psicológico de nenhum tipo. Se você tem sentido medo intenso que não cede, se tem evitado sair de casa, se o sono e o apetite mudaram muito, se há sensação persistente de perseguição, ou se a preocupação com proteção espiritual ocupa boa parte dos seus dias, isso merece avaliação de profissional de saúde. Psiquiatra, psicólogo, a Unidade Básica de Saúde do bairro, um CAPS. Havendo risco imediato, procure atendimento agora ou ligue para o [CVV no 188](https://www.cvv.org.br/), gratuito e 24 horas.

Desconfie de quem vende proteção associada a medo, de quem primeiro afirma que você está em risco e depois oferece o objeto que resolve. Os limites do que atendo estão no [aviso de cuidado](/aviso-de-cuidado).
:::
