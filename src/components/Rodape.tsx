      ...
      <div className="mx-auto max-w-6xl px-5 py-14 lg:px-8">
        <div className="grid gap-10 md:grid-cols-3 lg:grid-cols-4">
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 font-display text-sm uppercase tracking-[0.2em] text-areia-50">
              Espaço da Completude
            </p>
            <p className="mt-1.5 text-[0.7rem] uppercase tracking-[0.42em] text-ouro-400">Caio Gracco</p>
        ...
        <div className="flex flex-col gap-3 text-[0.78rem] text-noite-300 sm:flex-row sm:items-center sm:justify-between">
          <p>© {ano} Espaço da Completude · Caio Gracco · CNPJ {site.cnpj}</p>
